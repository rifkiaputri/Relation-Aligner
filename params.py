...
class args():
    def __init__(self):
        ...
        self.train_filename = 'dataset/train_align_all.tsv'
        ...
        self.save_dir = 'models/data_v7'  # model save path
        
        # Mode
        self.mode = 'nodef'
        self.predict_dir = 'predict/data_v7/pcnn_' + self.mode
        self.gold_dir = 'predict/data_v7/gold/pcnn_' + self.mode
